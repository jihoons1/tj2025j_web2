...
export default function Component9(props){
    ...
    // [1] axios : React.js 주로 사용되는 REST API Q비동기 통신 함수,
    // [2] 사용법 : 
    //      1. 설치( node.js ) : 라이브러리 주소
    //          (1) 리액트 서버가 종료된 상태에서
    //          (2) 리액트 폴더와 최상위 폴더로 터미널 열기 : [reactApp] 폴더 오른쪽 클릭->[터미널열기]
    ...
    // [3-4] asios delete test
    const onAxios4 = async()=>{
        const obj = { id: 1 , title: 'foo', body: 'bar', userId: 1 }
        const response4 = await axios.delete("https://jsonplaceholder.typicode.com/posts/1", obj)
