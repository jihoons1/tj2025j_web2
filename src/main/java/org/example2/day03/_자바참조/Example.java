package org.example2.day03._자바참조;
...
public class Example {
    public static void main(String[] args) {
        ...
        // .참조 : A.B A안에 B를 참조 , A가 NULL 이면 B를 참조할수 없다. NULL POINTER

        // JAP는 영속성 : 데이터베이스랑 자바랑 비슷하구나.
        ...
        board1.setBno( 1 ); board1.setBitlte("공지1");
        board1.setBcontent("공지내용1");
        //** 1번 게시물에 1번 공지사항 참조 **//
        board1.setCategory( category1 );
        System.out.print(board1.getCategory().getCname());
