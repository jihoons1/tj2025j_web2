package org.example2.day04.controller;

import lombok.RequiredArgsConstructor;
import org.example2.day04.model.dto.TodoDto;
import org.example2.day04.service.TodoService;
...
public class TodoController {
    ...
    // [4] 페이징처리
    // http://localhost:8080/api/todo/page?page=2&size=3
    @GetMapping("/page")
    ...
    // [5] 2-5
    // http://localhost:8080/api/todo/page2?page=1&size=5&keyword=공부
    // http://localhost:8080/api/todo/page2?page=1&size=5&keyword=
    @GetMapping("/page2")
