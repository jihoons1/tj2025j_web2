package org.example2.day04.model.repository;
...
public interface TodoRepository
    ...
    // findByTitle( String title ) <---> select * from todo where title = 매개변수
    List<TodoEntity> findByTitle( String title ); //  findBy필드명( String 매개변수 ) ,
