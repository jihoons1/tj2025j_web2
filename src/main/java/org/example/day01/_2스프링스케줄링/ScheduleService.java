package org.example.day01._2스프링스케줄링;
...
//    @Scheduled( cron = "초 분 시 일 월 요일 ")
    ...
    @Scheduled( cron = "0 */1 * * * *") // 현재시스템 시간이 00초 될떄 마다 실행
    public void task4(){
        System.out.println("[cron1분] ScheduleService.task\n" + "[1분] 마다 실행");
    }

//    @Scheduled( cron = "*/1 * * * * *") // 1초마다 실행
//    public void task5(){
//        System.out.println("[cron1초] ScheduleService.task3\n" + "[1초] 마다 실행");
//    } // func end
