...
// [2] 인터페이스 : 주로 상수와 추상메소드(구현부없는) 를 정의한다.
...
public class Example1 {
    ...
    public static void main(String[] args) {
        // [1] 일반 메소드 호출 : static 일때
        int result  = plus(3 ,5 );
        System.out.println("[3] 일반 메소드 호출 : " + result );
