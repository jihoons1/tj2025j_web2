 -- 1. 책 테이블
    ...
    -- 3. 샘플 데이터 (책 목록)
    INSERT INTO books (id, title, stock , price) VALUES (1, '자바의 정석', 3 , 4100);
    INSERT INTO books (id, title, stock , price) VALUES (2, '스프링 인 액션', 2 , 4200);
    INSERT INTO books (id, title, stock , price) VALUES (3, '토비의 스프링', 1 , 4300);
    INSERT INTO books (id, title, stock , price) VALUES (4, '리액트 교과서', 5 , 4400);
